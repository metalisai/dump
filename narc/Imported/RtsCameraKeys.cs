...
public class RtsCameraKeys : MonoBehaviour
{
    ...
    protected void Update()
    {
        ...
        if (AllowMove && (!_rtsCamera.IsFollowing || MovementBreaksFollow))
        {
            ...
            {
                hasMovement = true;
                _rtsCamera.AddToPosition(h * speed * GameTime.RealDeltaTime, 0, 0);
            }
            ...
            {
                hasMovement = true;
                _rtsCamera.AddToPosition(0, 0, v * speed * GameTime.RealDeltaTime);
            }
        ...
        if (AllowRotate)
        {
            ...
            else
            {
                ...
                {
                    _rtsCamera.Rotation += RotateSpeed * GameTime.RealDeltaTime;
                }
        ...
        if (AllowZoom)
        {
            if (ZoomUsesInputAxis)
            {
                ...
                {
                    _rtsCamera.Distance += zoom * ZoomSpeed * GameTime.RealDeltaTime;
                }
            }
            else
            {
                ...
                {
                    _rtsCamera.Distance += ZoomSpeed * GameTime.RealDeltaTime;
                }
        ...
        if (AllowTilt)
        {
            ...
            else
            {
                ...
                {
                    _rtsCamera.Tilt += TiltSpeed * GameTime.RealDeltaTime;
                }
